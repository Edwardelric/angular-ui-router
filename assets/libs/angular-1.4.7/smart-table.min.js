...
* @license MIT
*/
!function(t,e){"use strict";t.module("smart-table",[]).run(["$templateCache",function(t){t.put("template/smart-table/pagination.html",
	'<div class="dataTables_paginate paging_bootstrap">'+
	'<ul class="pagination" style="margin:0;">'+
		'<li class="first" ng-class="{disabled:currentPage==1}"><a ng-click="selectPage(1)"><i class="icon-leftdoublearrow"></i></a></li>'+
		'<li class="previous" ng-class="{disabled:currentPage==1}"><a ng-click="selectPage(currentPage,-1)"><i class="icon-leftarrow"></i></a></li>'+
	'</ul>'+
	'<ul class="pagination" style="margin:0;">'+
